...
let tyrannosaurus = new dinosaurs ({
  name: "tyrannosaurus",
  diet: "carnivorous",
  weight: 7000,
  length: 12,
...
let velociraptor = new dinosaurs ({
  name: "velociraptor",
  diet: "carnivorous",
  weight: 15,
  length: 1.8,
...
lowCaseAnimalNames = zooAnimals.map(a => {return a.animal_name.toLocaleLowerCase()})
...
lowPopulationAnimals = zooAnimals.filter(a => {return a.population < 5})
